...
public class MedicamentoController {
     ...
     * CHECKED!!!
     * 
     * @param id del medicamento a modificar
     * @param medicamento el conjunto de medicamentos modificado
    ...
    public ResponseEntity<List<Medicamento>> buscarPorPrincipioActivo(
            @RequestParam("principioActivo") String principioActivo) {
    ...
    /**
     * HU-A8
     * CHECKED!!! con post body:  { "nombreComercial": "Paracetamol REST", "principioActivo": "REST", "fabricante": "Kern REST", "familia": "Analgésico", "numDosis": 20 }
     * 
